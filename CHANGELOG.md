...
## [Unreleased]
### Added
- The possibility to import/export a card selection scenario (issue [#9]) via the new methods `exportCardSelectionScenario`,
  `importCardSelectionScenario` and `scheduleCardSelectionScenario` exposed in the `CardSelectionManager` API.
...
[unreleased]: https://github.com/calypsonet/calypsonet-terminal-reader-java-api/compare/1.0.0...HEAD
